...
const WhyBuuk = () => {
  return (
    <section id="why-buuk" className="py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div>
            <div className="inline-flex items-center space-x-2 bg-lime-50 border border-lime-100 rounded-full px-4 py-2 mb-6">
              <Star className="w-4 h-4 text-lime-600 fill-lime-600" />
              <span className="text-sm font-medium text-lime-900">Why Choose buuk</span>
            </div>
          ...
          <div className="relative">
              ...
              <div className="mt-8 pt-8 border-t border-teal-500">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-teal-200 text-sm">Owner, Luxe Beauty Salon</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Decorative Element */}
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-lime-200 rounded-full mix-blend-multiply filter blur-2xl opacity-40 -z-10"></div>
          </div>
        </div>
      </div>
    </section>
